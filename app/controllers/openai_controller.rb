...
class OpenaiController < ApplicationController
    ...
    def restaurant_recommendations
        ...
        # Generate a unique cache key based on responses and location
        cache_key = generate_cache_key(user_responses, activity_location, date_notes)

        # Try fetching from cache, otherwise generate new recommendations
...
# Generates a cache key based on the user responses and activity location
...
# Calls OpenAI to get recommendations if not in cache
